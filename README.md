...
IDs, validation, and the rebuild/relaunch sequence. In the standalone
launcher, community downloads happen only through **Download Selected
Community Assets**. Use **Use Local Community Assets** for full pack ZIPs you
already have; **Start** never downloads community content.
