...
| Patch | Why |
| --- | --- |
| `defenderbots/0001-recover-stalled-spawn-nav.patch` | Recovers prepared defenders that cannot leave spawn, with configurable bounds, community-map objective fallbacks and admin diagnostics. |
