...
| Patch | Why |
| --- | --- |
| `defenderbots/0001-recover-stalled-spawn-nav.patch` | Defender bots retry refused paths. A bot still in spawn with either no route to the hatch or less than 96 units of horizontal progress over six seconds is moved near the hatch; connected, moving bots are unchanged. |
