...
var sheetCuts = map[string]map[string]bool{
	...
	"Dragon's Fury":        names("accuracy", "projectile-speed"),
	"Flame Thrower":        names("fire-rate"),
	"Flare Gun":            names("accuracy", "clip-size"),
	"Flying Guillotine":    names("accuracy", "fire-rate"),
	"Gas Passer":           names("gesture-speed", "projectile-penetration"),
	...
	"Sticky Jumper":        names("accuracy", "airborne-crits", "airborne-minicrits", "crits-on-kill", "crits-vs-burning", "damage", "drop-health-pack", "heal-on-kill", "mad-milk", "minicrits-on-kill", "minicrits-to-crits", "rocket-jump-protection", "speed-on-kill"),
