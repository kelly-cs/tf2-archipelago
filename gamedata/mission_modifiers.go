...
var MissionModifiers = []MissionModifier{
	...
	{Key: "one_in_the_chamber", Name: "Make it Count", Kind: "players", Description: "RED non-melee weapons and sentries deal 2.5x damage. RED reserve ammo and Engineer metal capacity are reduced by 75%; dispensers supply ammo and metal every four seconds."},
}
